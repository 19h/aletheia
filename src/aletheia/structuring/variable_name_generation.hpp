...
public:
    ...
    static void remove_self_assignments(ControlFlowGraph* cfg, DecompilerArena* arena = nullptr);
    ...
    static void remove_self_assignments_ast(AbstractSyntaxForest* forest, DecompilerArena* arena = nullptr);
};
