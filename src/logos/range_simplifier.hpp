#pragma once
#include "dag.hpp"
#include "../aletheia/structures/dataflow.hpp"
#include <cstdint>
#include <optional>
...
public:
    ...
    void update_with(aletheia::OperationType op, std::int64_t const_val, bool const_is_lhs);
...
struct BoundRelation {
    aletheia::OperationType op;
    aletheia::Expression* variable_expr;  // The non-constant operand
    ...
    static std::optional<BoundRelation> from(aletheia::Expression* expr);
...
public:
    ...
    static aletheia::Expression* simplify(aletheia::Expression* expr, aletheia::DecompilerArena& arena);
};
...
public:
    ...
    static aletheia::Expression* simplify(aletheia::Operation* op, aletheia::DecompilerArena& arena);
};
...
public:
    ...
    bool is_unfulfillable(aletheia::Expression* condition);
    ...
    aletheia::Expression* simplify(aletheia::Expression* condition, aletheia::DecompilerArena& arena);
