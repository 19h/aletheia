...
public:
    ...
    z3::expr convert(aletheia::DataflowObject* obj);
    
    // Explicit condition conversions
    LogicCondition convert_to_condition(aletheia::DataflowObject* obj);

private:
    z3::context& ctx_;
    std::uint64_t fresh_symbol_id_ = 0;

    z3::expr convert_constant(aletheia::Constant* c);
    z3::expr convert_variable(aletheia::Variable* v);
    z3::expr convert_operation(aletheia::Operation* o);
