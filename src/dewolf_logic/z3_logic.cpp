...
bool is_boolean_operation(dewolf::OperationType type) {
    using dewolf::OperationType;
    switch (type) {
...
LogicCondition Z3Converter::convert_to_condition(dewolf::DataflowObject* obj) {
